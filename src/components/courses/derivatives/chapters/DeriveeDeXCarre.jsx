...
const DeriveeDeXCarre = () => {
    ...
    var fCarreePrim2 = "\\((x^2)' = lim_{ h \\to 0} \\enspace \\frac{(x+h)^2 - (x)^2}{h }\\)";
    var fCarreePrim3 = "\\((x^2)' = lim_{ h \\to 0} \\enspace \\frac{x^2 + 2xh + h^2 - x^2}{h }\\)";
    var fCarreePrim4 = "\\((x^2)' = lim_{ h \\to 0} \\enspace \\frac{2xh + h^2}{h }\\)";
    var fCarreePrim5 = "\\((x^2)' = lim_{ h \\to 0} \\enspace h. \\frac{(2x + h)}{h }\\)";
    var fCarreePrim6 = "\\((x^2)' = lim_{ h \\to 0} \\enspace 2x + h\\)";

    var fCarreePrim7 = "\\( (x^2)' = lim_{ h \\to 0} \\enspace (2x + h)\\)";
    ...
    return  <>
                ...
                <MathJaxDisplay toShow={fCarreePrim7} demo /> 
