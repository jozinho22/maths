...
const MethodeDeNewtonExemple = () => {
    ...
    var xSquareRoot2Functions = "\\( \\Biggl\\{ \\begin{gather*}  g(x) = x^2 - 2 \\\\ \\enspace  g'(x) = 2x \\end{gather*} \\)";
    ...
    return  <>
                ...
                <p>Soit la valeur d'une fonction pour laquelle <MathJaxInline toShow={"$ x =\\sqrt{2} $"} /> lorsque cette fonction s'annule.</p>
                <MathJaxDisplay toShow={xSquareRoot2} demo /> 
                <MathJaxDisplay toShow={xSquareRoot22} demo /> 
                <MathJaxDisplay toShow={xSquareRoot23} demo /> 

                <p>Nous allons alors étudier la fonction <MathJaxInline toShow={"$ g $"} /> définie par : </p>
                ...
                <p>Au chapitre précédent sur <Link url={`${PagesConstants.COURS}${CoursesConstants.DERIVEE}/methode-de-newton`} external >la présentation de la méthode</Link>, nous avons vu que ce nombre peut être calculé sous la forme d'une suite récurrente telle que : </p>
