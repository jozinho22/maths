...
const Caracteristiques = () => {
    ...
    return (
            <>
                ...
                <p>Avec <Link url={`${PagesConstants.PREFIX}${PagesConstants.COURS}${CoursesConstants.PRODUIT_EN_CROIX}`} external>le produit en croix</Link>, on sait que cela peut s'écrire :</p>
