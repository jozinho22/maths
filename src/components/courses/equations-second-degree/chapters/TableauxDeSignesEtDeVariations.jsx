...
const TableauxDeSignesEtDeVariations = () => {
    ...
    return  <>
                ...
                <p>De plus, on a vu dans <Link url={`${PagesConstants.COURS}${CoursesConstants.DERIVEE}/sens-de-variations`} external>le chapitre sur le calcul des variations d'une fonction</Link> qu'on peut trouver ses variations grâce à la dérivée.</p>
