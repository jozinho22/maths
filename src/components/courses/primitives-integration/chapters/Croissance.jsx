...
const Croissance = () => {
    ...
    var ineqfgDemo = "\\( \\Lonleftrightarrow f(t) - g(t) \\leq 0 \\)";
    var ineqfgDemo2 = "\\( \\Lonleftrightarrow  \\int_a^b \\Bigl(f(t) - g(t)\\Bigr) dt \\leq 0 \\)";
    var ineqfgDemo3 = "\\( \\Lonleftrightarrow  \\int_a^b f(t)dt - \\int_a^b g(t) dt \\leq 0 \\)";
