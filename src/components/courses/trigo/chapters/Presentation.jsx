...
const Definition = () => {
    ...
    return (
            <>
                ...
                <p>
                    Dans le cercle trigonométrique, on utilisera π comme une mesure d'angle (voir le chapitre sur <Link url={`${PagesConstants.COURS}${CoursesConstants.PI}`} external>le nombre π</Link>)
                    {"\n"}
