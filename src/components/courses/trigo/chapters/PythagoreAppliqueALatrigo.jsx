...
const PythagoreAppliqueALatrigo = () => {
    ...
    return (
            <>
                ...
                <p>Et on sait que dans un triangle rectangle, grâce au <Link url={pathBuilder(`${PagesConstants.COURS}${CoursesConstants.PYTHAGORE}`)} external>théorème de Pythagore</Link>, <MathJaxInline toShow={"$ a^2 + b^2 = c^2$"} />, soit : </p>
                <MathJaxDisplay toShow={pyth2} demo />
