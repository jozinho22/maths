...
const DeriveesDeSinEtCos = () => {
    ...
    return (
        <>   
            ...
            <p>Avec la formule <MathJaxInline toShow={"$(2)$"} /> vue dans <Link url={`${PagesConstants.PREFIX}${PagesConstants.COURS}${CoursesConstants.TRIGO}/formules-d-addition`} external>les formules d'addition</Link>, on a :</p>   
            ...
            <p>Idem que précédemment, toujours dans <Link url={`${PagesConstants.PREFIX}${PagesConstants.COURS}${CoursesConstants.TRIGO}/formules-d-addition`} external>les formules d'addition</Link>, avec la formule <MathJaxInline toShow={"$(3)$"} />, on a :</p>   
