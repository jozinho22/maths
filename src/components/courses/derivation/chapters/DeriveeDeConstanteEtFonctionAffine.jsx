...
const DeriveeDeConstanteEtFonctionAffine = () => {
    ...
    var fCte = "\\( \\forall x \\in \\mathbb{R}, \\enspace f(x)= \\lambda, \\enspace (avec \\enspace \\lambda \\in \\mathbb{R})\\)";
    var fCtePrim = "\\((\\lambda)' =  lim_{ h \\to 0} \\enspace \\frac{\\lambda - \\lambda}{h }\\)";
    var fCtePrim2 = "\\( \\Longleftrightarrow lim_{ h \\to 0} \\enspace \\frac{0}{h }\\)";
    var fCtePrim3 = "\\( \\Longleftrightarrow lim_{ h \\to 0} \\enspace 0\\)";
    var fCtePrim4 = "\\( (\\lambda)' = 0 \\)";
