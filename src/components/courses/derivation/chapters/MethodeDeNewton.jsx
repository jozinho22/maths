...
const MethodeDeNewton = () => {
    ...
    return  <>
                ...
                <p>Nous avons représenté <Link url={`${PagesConstants.PREFIX}${PagesConstants.COURS}${CoursesConstants.DERIVATION}/equation-de-la-tangente`} external >la tangente de cette courbe</Link> au point <MathJaxInline toShow={"$ x = a_0 $"} />, et répondant à l'équation :</p>
