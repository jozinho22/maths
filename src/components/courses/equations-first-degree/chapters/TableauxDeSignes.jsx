...
const TableauxDeSignes = () => {
    ...
    return  <>
                ...
                <p>Si nous reprenons notre exemple de fonction du <Link url={`${PagesConstants.COURS}${PagesConstants.PREFIX}${CoursesConstants.EQ_1_DEG}/resolution`} external>premier chapitre</Link>, <MathJaxInline toShow={"$f(x) = 2x + 3$"} />, nous pouvons dessiner son tableau de signe.</p>
