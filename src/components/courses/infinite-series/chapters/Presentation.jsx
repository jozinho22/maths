...
const Presentation = () => {
    ...
    var limDev = "\\( f_{n, a}(x) = f(x - a) + \\frac{f^{(1)}(x - a)}{1!} + + \\frac{f^{(2)}(x - a)^2}{2!} + ... + \\frac{f^{(n)}(x - a)^n}{n!}  + o( (x-a)^{n+1})\\)";
    ...
    return  <>
                ...
                <p><MathJaxInline toShow={"$ o(x^{n+1}) $"} /> est appellée partie irrégulière (ou reste).</p>
