...
const Presentation = () => {
    ...
    return  <>
                ...
                <p>Étant donnée une suite <MathJaxInline toShow={"$(u_n) \\in \\mathbb{K}^{\\mathbb{N}} $"} />, de nombres réels ou complexes, on lui associe la suite <MathJaxInline toShow={"$(S_n)_{n \\in \\mathbb{N}} $"} /> définie par :</p>
                ...
                <p>Pour <MathJaxInline toShow={"$n$"} /> fixé, <MathJaxInline toShow={"$(S_n)$"} /> s'appelle la somme partielle de la série <MathJaxInline toShow={"$ S_n = \\sum u_n$"} />.</p>
