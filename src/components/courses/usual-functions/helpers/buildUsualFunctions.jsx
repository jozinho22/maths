...
const buildUsualFunctions = () => {
    ...
    return [
            ...
            },
            {
                ...
                definition: "\\(\\mathcal{D}  = [-\\pi + 2k\\pi ; \\pi + 2k\\pi] \\enspace (k \\in \\mathbb{Z}) \\)",
                definition2: "\\(\\mathcal{D} = \\mathbb{R} \\)",
                derivative: "-sin(x)",
                primitive: "sin(x) + K",
                type: 'trigo',
            ...
            },
            {
                ...
                definition: "\\(\\mathcal{D}  = \\Bigl]-\\frac{\\pi}{2} + k\\pi ; \\frac{\\pi}{2} + k\\pi \\Bigr[ \\enspace \\enspace (k \\in \\mathbb{Z}) \\)",
                definition2: "\\(\\mathcal{D} = \\mathbb{R} - \\Bigl\\{ \\frac{\\pi}{2} + k\\pi \\Bigr\\} \\enspace \\enspace (k \\in \\mathbb{Z})  \\)",
