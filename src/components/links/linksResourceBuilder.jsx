function linksResourceBuilder() {
    ...
    var graineDeSens = {
      id: i++,
      link: 'https://www.bretagne-grainedesens.bzh/',
    ...
    var noesis = {
      id: i++,
      link: 'https://ecolenoesis.org/accueil/bienvenue',
    ...
    var savoirSansFrontieres = {
      id: i++,
      link: 'http://www.savoir-sans-frontieres.com/',
    ...
    var gerardVillemin = {
      id: i++,
      link: 'http://villemin.gerard.free.fr/',
...
export default linksResourceBuilder;