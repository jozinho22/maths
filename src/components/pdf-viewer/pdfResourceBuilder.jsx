...
function pdfResourceBuilder() {
    ...
    var pdfMilleEtUneNuits = {
      ...
      hiddenTitle: 'Bande dessinée de Jean-Pierre Petit : Les 1001 nuits scientifiques',
    ...
    var pdfPourQqesAmperes = {
      ...
      hiddenTitle: 'Bande dessinée de Jean-Pierre Petit : Pour quelques ampères de plus',
